...
const T = {
  en: {
    ...
    workKicker: 'services · let’s create together',
    workTitle: 'work',
    workTitleItalic: 'with me',
    workSubtitle: 'From a raw manuscript to a finished, publish-ready book — choose the level of support that fits where you are.',
    workPackageLabel: 'package',
    workIncludedLabel: 'What’s included',
    workTimelineLabel: 'Timeline',
    workInvestmentLabel: 'Investment',
    workExclVat: 'excl. VAT',
    workDefaultMessage: 'I’m interested in working with you.',
    workGetInTouch: 'Get in touch',
    workCtaTitle: 'Not sure which package fits?',
    workCtaTitleItalic: 'Let’s talk.',
    workCtaBody: 'Every project is different. Reach out and we’ll find the right path together.',
    workCtaBtn: 'Say hello',
    workEmailSubject: 'Work with me — general inquiry',
    pkg1Title: 'From Manuscript to Book',
    pkg1Subtitle: 'Bringing your creative projects to life',
    pkg1Description: 'You have a story. I help you turn it into a complete, publish-ready book — from the first word to the final upload.',
    pkg1Includes: [
      'Editorial consultation — refining your text into a fluid, cohesive narrative',
      '7 original illustrations + cover design',
      'Professional layout & typesetting',
      'ISBN registration support',
      'Amazon upload & publishing setup (when applicable)',
      '3 rounds of revisions',
    ],
    pkg1Timeline: '5 weeks',
    pkg2Title: 'Editorial Consultation',
    pkg2Subtitle: 'Bringing your story into focus',
    pkg2Description: 'You have a manuscript. I help you see it clearly — what’s working, what needs refinement, and how to transform it into a fluid, publish-ready narrative.',
    pkg2Includes: [
      'Full manuscript read & written feedback report',
      '2 rounds of written feedback',
      '2 video calls to discuss revisions and next steps',
    ],
    pkg2Timeline: 'To be agreed upon based on manuscript length',
    pkg3Title: 'Graphic Production',
    pkg3Subtitle: 'Your story, beautifully designed',
    pkg3Description: 'Your manuscript is ready. I take care of everything visual — turning your text into a professionally designed, publish-ready book.',
    pkg3Includes: [
      'Professional layout & typesetting',
      'Cover design (illustration upon request — price to be confirmed)',
      'ISBN registration support',
      'Amazon upload & publishing setup (when applicable)',
      '2 rounds of revisions',
    ],
    pkg3Timeline: '2–3 weeks',
    illustSectionKicker: 'illustrations · wedding & stationery',
    illustSectionTitle: 'Wedding Illustration',
    illustSectionTitleItalic: '& Stationery',
    illustSectionSubtitle: 'I create custom couple portraits and wedding stationery that blend warmth, personality, and a hand-crafted feel — perfect for couples who want something truly unique instead of a template.',
    illustFromLabel: 'From',
    illust1Title: 'Save the Date',
    illust1Desc: 'Custom couple portrait + digital save the date card.',
    illust1Investment: '1.200 SEK',
    illust2Title: 'Wedding Invitation',
    illust2Desc: 'Couple portrait + full invitation design, ready to send digitally or print.',
    illust2Investment: '1.800 SEK',
    illust3Title: 'Full Digital Stationery Suite',
    illust3Desc: 'Portrait + save the date + invitation + menu + thank you card.',
    illust3Investment: '4.500 SEK',
    illust4Title: 'Full Stationery Suite with Print-Ready Files',
    illust4Desc: 'Everything above, delivered as print-ready files for your printer of choice.',
    illust4Investment: '6.000 SEK',
    illust5Title: 'Premium Wedding Package',
    illust5Desc: 'Complete wedding visual identity: portrait, full stationery suite, colour palette, and design elements you can use across your entire celebration.',
    illust5Investment: '10.000 SEK',
  ...
  pt: {
    ...
    navShop: 'loja',
    navContact: 'contato',
    navWork: 'trabalhe comigo',
    workKicker: 'serviços · vamos criar juntos',
    workTitle: 'trabalhe',
    workTitleItalic: 'comigo',
    workSubtitle: 'De um manuscrito bruto a um livro finalizado e pronto para publicação — escolha o nível de suporte que se encaixa no seu momento.',
    workPackageLabel: 'pacote',
    workIncludedLabel: 'O que está incluído',
    workTimelineLabel: 'Prazo',
    workInvestmentLabel: 'Investimento',
    workExclVat: 'excl. IVA',
    workDefaultMessage: 'Tenho interesse em trabalhar com você.',
    workGetInTouch: 'Entre em contato',
    workCtaTitle: 'Não sabe qual pacote é ideal?',
    workCtaTitleItalic: 'Vamos conversar.',
    workCtaBody: 'Cada projeto é único. Entre em contato e encontraremos juntos o melhor caminho.',
    workCtaBtn: 'Diga olá',
    workEmailSubject: 'Trabalhe comigo — consulta geral',
    pkg1Title: 'Do Manuscrito ao Livro',
    pkg1Subtitle: 'Dando vida aos seus projetos criativos',
    pkg1Description: 'Você tem uma história. Eu ajudo a transformá-la em um livro completo e pronto para publicação — da primeira palavra ao upload final.',
    pkg1Includes: [
      'Consultoria editorial — refinando seu texto em uma narrativa fluida e coesa',
      '7 ilustrações originais + design de capa',
      'Diagramação e tipografia profissional',
      'Suporte para registro de ISBN',
      'Upload e configuração de publicação na Amazon (quando aplicável)',
      '3 rodadas de revisões',
    ],
    pkg1Timeline: '5 semanas',
    pkg2Title: 'Consultoria Editorial',
    pkg2Subtitle: 'Trazendo sua história para o foco',
    pkg2Description: 'Você tem um manuscrito. Eu ajudo a enxergá-lo com clareza — o que está funcionando, o que precisa ser refinado e como transformá-lo em uma narrativa fluida e pronta para publicação.',
    pkg2Includes: [
      'Leitura completa do manuscrito + relatório de feedback escrito',
      '2 rodadas de feedback escrito',
      '2 videochamadas para discutir revisões e próximos passos',
    ],
    pkg2Timeline: 'A combinar conforme o tamanho do manuscrito',
    pkg3Title: 'Produção Gráfica',
    pkg3Subtitle: 'Sua história, lindamente projetada',
    pkg3Description: 'Seu manuscrito está pronto. Eu cuido de tudo o que é visual — transformando seu texto em um livro profissionalmente diagramado e pronto para publicação.',
    pkg3Includes: [
      'Diagramação e tipografia profissional',
      'Design de capa (ilustração sob consulta — valor a confirmar)',
      'Suporte para registro de ISBN',
      'Upload e configuração de publicação na Amazon (quando aplicável)',
      '2 rodadas de revisões',
    ],
    pkg3Timeline: '2 a 3 semanas',
    illustSectionKicker: 'ilustrações · casamento & papelaria',
    illustSectionTitle: 'Ilustração de Casamento',
    illustSectionTitleItalic: '& Papelaria',
    illustSectionSubtitle: 'Crio retratos personalizados de casais e papelaria de casamento que combinam calor, personalidade e um toque artesanal — perfeito para casais que querem algo verdadeiramente único em vez de um modelo pronto.',
    illustFromLabel: 'A partir de',
    illust1Title: 'Save the Date',
    illust1Desc: 'Retrato personalizado do casal + cartão save the date digital.',
    illust1Investment: '1.200 SEK',
    illust2Title: 'Convite de Casamento',
    illust2Desc: 'Retrato do casal + design completo do convite, pronto para enviar digitalmente ou imprimir.',
    illust2Investment: '1.800 SEK',
    illust3Title: 'Kit de Papelaria Digital Completo',
    illust3Desc: 'Retrato + save the date + convite + menu + cartão de agradecimento.',
    illust3Investment: '4.500 SEK',
    illust4Title: 'Kit de Papelaria Completo com Arquivos para Impressão',
    illust4Desc: 'Tudo acima, entregue como arquivos prontos para impressão na gráfica de sua escolha.',
    illust4Investment: '6.000 SEK',
    illust5Title: 'Pacote Premium de Casamento',
    illust5Desc: 'Identidade visual completa do casamento: retrato, kit de papelaria completo, paleta de cores e elementos de design para usar em toda a celebração.',
    illust5Investment: '10.000 SEK',
  ...
  sv: {
    ...
    navShop: 'butik',
    navContact: 'kontakt',
    navWork: 'arbeta med mig',
    workKicker: 'tjänster · låt oss skapa tillsammans',
    workTitle: 'arbeta',
    workTitleItalic: 'med mig',
    workSubtitle: 'Från ett råmanuskript till en färdig, publiceringsredo bok — välj den nivå av stöd som passar dig.',
    workPackageLabel: 'paket',
    workIncludedLabel: 'Vad ingår',
    workTimelineLabel: 'Tidslinje',
    workInvestmentLabel: 'Investering',
    workExclVat: 'exkl. moms',
    workDefaultMessage: 'Jag är intresserad av att arbeta med dig.',
    workGetInTouch: 'Kontakta mig',
    workCtaTitle: 'Osäker på vilket paket som passar?',
    workCtaTitleItalic: 'Låt oss prata.',
    workCtaBody: 'Varje projekt är unikt. Hör av dig så hittar vi rätt väg tillsammans.',
    workCtaBtn: 'Säg hej',
    workEmailSubject: 'Arbeta med mig — allmän förfrågan',
    pkg1Title: 'Från Manuskript till Bok',
    pkg1Subtitle: 'Vi förverkligar dina kreativa projekt',
    pkg1Description: 'Du har en berättelse. Jag hjälper dig att förvandla den till en komplett, publiceringsredo bok — från det första ordet till den slutliga uppladdningen.',
    pkg1Includes: [
      'Redaktionell konsultation — finjusterar din text till en flytande, sammankopplad berättelse',
      '7 original illustrationer + omslagsdesign',
      'Professionell layout & typsättning',
      'Stöd för ISBN-registrering',
      'Uppladdning och publiceringsinställningar på Amazon (när tillämpligt)',
      '3 revisionsrundor',
    ],
    pkg1Timeline: '5 veckor',
    pkg2Title: 'Redaktionell Konsultation',
    pkg2Subtitle: 'Vi för din berättelse i fokus',
    pkg2Description: 'Du har ett manuskript. Jag hjälper dig att se det tydligt — vad som fungerar, vad som behöver förbättras och hur du omvandlar det till en flytande, publiceringsredo berättelse.',
    pkg2Includes: [
      'Fullständig manuskriptläsning & skriftlig feedbackrapport',
      '2 rundor med skriftlig feedback',
      '2 videosamtal för att diskutera revisioner och nästa steg',
    ],
    pkg2Timeline: 'Overenskommes baserat på manuskriptets längd',
    pkg3Title: 'Grafisk Produktion',
    pkg3Subtitle: 'Din berättelse, vackert designad',
    pkg3Description: 'Ditt manuskript är klart. Jag tar hand om allt det visuella — och förvandlar din text till en professionellt designad, publiceringsredo bok.',
    pkg3Includes: [
      'Professionell layout & typsättning',
      'Omslagsdesign (illustration på begäran — pris bekräftas)',
      'Stöd för ISBN-registrering',
      'Uppladdning och publiceringsinställningar på Amazon (när tillämpligt)',
      '2 revisionsrundor',
    ],
    pkg3Timeline: '2–3 veckor',
    illustSectionKicker: 'illustrationer · bröllop & brevpapper',
    illustSectionTitle: 'Bröllopsillustration',
    illustSectionTitleItalic: '& Brevpapper',
    illustSectionSubtitle: 'Jag skapar anpassade parporträtt och bröllopsartiklar som kombinerar värme, personlighet och en handgjord känsla — perfekt för par som vill ha något verkligt unikt istället för en mall.',
    illustFromLabel: 'Från',
    illust1Title: 'Save the Date',
    illust1Desc: 'Anpassat parporträtt + digitalt save the date-kort.',
    illust1Investment: '1.200 SEK',
    illust2Title: 'Bröllopsinbjudan',
    illust2Desc: 'Parporträtt + komplett inbjudningsdesign, redo att skicka digitalt eller trycka.',
    illust2Investment: '1.800 SEK',
    illust3Title: 'Komplett Digitalt Brevpapperspaket',
    illust3Desc: 'Porträtt + save the date + inbjudan + meny + tackkort.',
    illust3Investment: '4.500 SEK',
    illust4Title: 'Komplett Brevpapperspaket med Tryckklara Filer',
    illust4Desc: 'Allt ovan, levererat som tryckklara filer för valfritt tryckeri.',
    illust4Investment: '6.000 SEK',
    illust5Title: 'Premium Bröllopspaket',
    illust5Desc: 'Komplett bröllopsvisuell identitet: porträtt, komplett brevpapperspaket, färgpalett och designelement att använda genom hela firandet.',
    illust5Investment: '10.000 SEK',
